...
# Ensure the Dragnet control schema contains dragnet\_nodes, dragnet\_schedule, module registry tables, and the log tables referenced by the dashboard loaders.
...
# Copy the contents of PythonScripts/ and/or the prebuilt executables in scripts/ to the worker’s allowed script directory (C:\\DragnetScripts on Windows or /opt/dragnet\_scripts on Linux).
